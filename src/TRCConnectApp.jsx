...
function HomePage() {
  ...
  const selectedObj = COUNTRIES.find((c) => c.code === selectedCountry);
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', -apple-system, sans-serif", color: C.navy, background: C.white }}>
      ...
      {/* NAVBAR */}      {/* HERO */}
      <section style={{
        background: `linear-gradient(160deg, ${C.navyDark} 0%, ${C.navy} 45%, #1E3A6E 100%)`,
        minHeight: "100vh",
        display: "flex",
        alignItems: "center",
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }} className="hero-grid">
            ...
            <div>
              <div style={{
                ...
                <span style={{ fontSize: 12, color: C.goldLight, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase" }}>
                  Global Tax Residency Platform
                </span>
              </div>
              ...
              <h1 style={{
                ...
                Your Tax Residency
                <br />
                <span style={{ color: C.gold, fontStyle: "italic" }}>Certificate,</span>
                <br />
                Handled Globally.
              </h1>
              ...
              <p style={{
                ...
                Connect with verified local tax advisors in 10+ countries. Transparent pricing, real-time tracking, and guaranteed compliance.
              </p>
              ...
              <div style={{ display: "flex", gap: 24, marginTop: 40, flexWrap: "wrap" }}>
                {[{ v: "10+", l: "Countries" }, { v: "200+", l: "Advisors" }, { v: "48h", l: "Avg. Delivery" }].map((s) => (
                  <div key={s.l}>
                    <div style={{ fontSize: 22, fontWeight: 800, color: C.gold, fontFamily: "'Cormorant Garamond', serif" }}>{s.v}</div>
                    <div style={{ fontSize: 12, color: "rgba(255,255,255,0.5)", textTransform: "uppercase", letterSpacing: "0.06em", marginTop: 2 }}>{s.l}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div style={{
              ...
              <p style={{ fontSize: 14, color: "rgba(255,255,255,0.55)", marginBottom: 32, lineHeight: 1.6 }}>
                Select a jurisdiction to see matched advisors and estimated timelines.
              </p>

              <div style={{ marginBottom: 20 }}>
                <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "rgba(255,255,255,0.6)", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 10 }}>
                  Target Country
                </label>
                <div style={{ position: "relative" }}>
                  <div
                    ...
                    style={{
                      ...
                      border: `1px solid ${dropdownOpen ? C.gold : "rgba(255,255,255,0.2)"}`,
                      borderRadius: 12,
                      padding: "14px 16px",
                      display: "flex",
                      alignItems: "center",
                  ...
                  >
                    <span style={{ color: selectedObj ? C.white : "rgba(255,255,255,0.4)", fontSize: 15, display: "flex", alignItems: "center", gap: 10 }}>
                      {selectedObj ? <>{selectedObj.flag} {selectedObj.name}</> : "Select a country..."}
                    </span>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.5)" strokeWidth="2" strokeLinecap="round" style={{ transition: "transform 0.2s", transform: dropdownOpen ? "rotate(180deg)" : "none" }}>
                    ...
                    <div style={{
                      ...
                      {COUNTRIES.map((c) => (
                        <div
                          ...
                          onClick={() => { setSelectedCountry(c.code); setDropdownOpen(false); }}
                          style={{
                            padding: "12px 16px",
                            cursor: "pointer",
                            display: "flex",
                            ...
                            background: selectedCountry === c.code ? C.offWhite : "transparent",
                            transition: "background 0.15s",
                          }}
                        >
                          <span style={{ fontSize: 18 }}>{c.flag}</span>
                          {c.name}
                          {selectedCountry === c.code && <span style={{ marginLeft: "auto", color: C.gold }}>✓</span>}
                        </div>
                      ))}
                    </div>
                  )}
              ...
              <button style={{
                ...
                {selectedObj ? `Find Advisors in ${selectedObj.name} →` : "Check Eligibility →"}
              </button>
        ...
        <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, lineHeight: 0 }}>
          <svg viewBox="0 0 1440 60" fill={C.white} xmlns="http://www.w3.org/2000/svg">
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            ...
            <h2 style={{
              ...
              <br />
              <span style={{ color: C.gold, fontStyle: "italic" }}>in Three Steps</span>
            </h2>
            <p style={{ fontSize: 17, color: C.textMuted, marginTop: 16, maxWidth: 520, margin: "16px auto 0", lineHeight: 1.7 }}>
              Our streamlined platform eliminates the complexity of international tax documentation.
            </p>
          </div>
          ...
          <div className="steps-grid" style={{ display: "flex", gap: 32, position: "relative" }}>
            ...
            <div className="hide-mobile" style={{
              ...
              height: 1,
              background: `linear-gradient(90deg, ${C.gold}00, ${C.gold}60, ${C.gold}00)`,
              zIndex: 0,
            }} />

            {STEPS.map((step, i) => (
              <div key={step.num} style={{ flex: 1, position: "relative", zIndex: 1 }}>
                <div style={{
                  ...
                  padding: "40px 32px",
                  height: "100%",
                  boxShadow: i === 1 ? `0 20px 60px rgba(15,37,87,0.2)` : "0 2px 16px rgba(15,37,87,0.05)",
                  ...
                  <div style={{
                    ...
                    height: 56,
                    borderRadius: 14,
                    background: i === 1 ? "rgba(201,168,76,0.2)" : `${C.gold}18`,
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    fontSize: 26,
                  ...
                  <p style={{
                    fontSize: 15,
                    color: i === 1 ? "rgba(255,255,255,0.65)" : C.textMuted,
                    lineHeight: 1.7,
                  }}>
                    {step.desc}
                  </p>
      ...
      {/* FEATURED ADVISORS */}
      <section style={{ background: C.offWhite, padding: "100px 24px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ fontSize: 16, color: "rgba(255,255,255,0.65)", maxWidth: 480, lineHeight: 1.6 }}>
                Join our verified network and reach clients seeking TRC assistance in your jurisdiction. Transparent fees, secure escrow, and full dashboard support.
              </p>
            </div>
            <button style={{
              background: `linear-gradient(135deg, ${C.gold}, ${C.goldDark})`,
      ...
      <section style={{ background: C.white, padding: "72px 24px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ fontSize: 15, color: C.textMuted, marginBottom: 40 }}>
            TRC services available in 10 countries, expanding to 25+ in 2025.
          </p>
          <div style={{
            display: "flex",
            flexWrap: "wrap",
            ...
            {COUNTRIES.map((c) => (
              <div
                ...
                onMouseEnter={e => {
                  ...
                  e.currentTarget.style.boxShadow = "0 6px 20px rgba(201,168,76,0.15)";
                }}
                onMouseLeave={e => {
      ...
      <footer style={{
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div className="footer-cols" style={{ display: "flex", gap: 64, marginBottom: 48, justifyContent: "space-between" }}>
            {/* Brand */}
            <div style={{ flex: "0 0 280px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
                ...
                <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 20, fontWeight: 700, color: C.white }}>
                  TRC<span style={{ color: C.gold, fontWeight: 400 }}> Connect</span>
                </span>
              </div>
              <p style={{ fontSize: 14, lineHeight: 1.7, color: "rgba(255,255,255,0.5)", maxWidth: 240 }}>
            ...
            {/* Countries */}
            <div>
              <h4 style={{ fontSize: 13, fontWeight: 700, color: C.white, textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 18 }}>
                Jurisdictions
              </h4>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px 32px" }}>
                {COUNTRIES.map((c) => (
                  <a key={c.code} href="#" style={{
                    fontSize: 14,
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                {["How It Works", "Find an Advisor", "Pricing", "Dashboard", "Advisor Portal", "Blog"].map((item) => (
          ...
          <div style={{
            ...
            <p style={{ fontSize: 13, color: "rgba(255,255,255,0.35)" }}>
              © 2025 TRC Connect Ltd. All rights reserved. Not a licensed tax advisory firm.
            </p>
            <p style={{ fontSize: 13, color: "rgba(255,255,255,0.35)" }}>
              Regulated advisors only · Secure escrow · End-to-end encrypted
            </p>
          </div>
        </div>
      </footer>

        ...
        <div style={{ marginBottom: 18, display: "flex", justifyContent: "space-between", gap: 16, alignItems: "center", flexWrap: "wrap" }}>
          <div style={{ display: "flex", alignItems: "flex-start", gap: 12, minWidth: 0 }}>
            <button
              ...
              style={{ display: "none", flexShrink: 0, width: 40, height: 40, borderRadius: 10, border: `1px solid ${C.border}`, background: C.white, color: C.navy, fontSize: 18, cursor: "pointer", alignItems: "center", justifyContent: "center" }}
            >
              ☰
            </button>
